...
C
 20   FORMAT(/' ================================================'
     ...
     &       /'   TR transition points       currently: ',2(F8.3),
     &       /'   N  N-crit for transition   currently: ',F9.3,
     &      //'   P  plot  BL data',
...
cc     *        '  Cdp  =',F12.6,'   Cftot  =',F12.6//
     *        3X,'S/Smax',4X,'S',8X,'X',8X,'Ue',7X,'Dstar',6X,'Theta',
cc     *        3X,'S/Smax',4X,'S',8X,'Ue',7X,'Dstar',6X,'Theta',
     *        6X,'H12  ',6X,'Cf   ',4X,'Amp')
  240 FORMAT (1X,F7.3,F9.3,F9.3,F9.3,2F11.5,F9.3,F11.5,F9.3)
